...
int main()
{
    ll   ttt,a,b, i, d, o, c, g, e, r, j, k, l,t=0, f = 0, h = 0, m, n, q, p, w, cnt;
    string s, s1;
    char cc;
    sf1(ttt);
    while (ttt--)
    {
        ...
        while(radius)
        {
            ans+= 3.1415926535 * radius * radius;
            if(f & 1) radius/=B;
            else radius*=A;
            f++;
        }
...
//Lint: https://codingcompetitions.withgoogle.com/kickstart/round/00000000008caa74/0000000000acf079
