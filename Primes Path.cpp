...
bool isValid(int a,int b){ // check weather one digit is differ.
...
void buildPrimeGraph(){
    rep(i,1000,9999) if(isPrime(i)) primes.pb(i);
...
int main(){
    ...
    while(t--){
        cin>>a>>b;
        rep(i,1000,9999+1) dis[i]=-1,vis[i]=0; //-1 for not possible.
        bfs(a);
