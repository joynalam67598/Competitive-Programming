...
// Monk and the island hackerearth. Link: https://www.hackerearth.com/practice/algorithms/graphs/breadth-first-search/practice-problems/algorithm/monk-and-the-islands/
...
int main(){
    ...
    while(t--){
        cin>>n>>m;
        rep(i,1,n+1) adj[i].clear(),vis[i]=0;
